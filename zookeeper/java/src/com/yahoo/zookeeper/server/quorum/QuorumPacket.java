...
public class QuorumPacket implements Record {
  ...
  private long zxid;
  private byte[] data;
  private java.util.List<com.yahoo.zookeeper.data.Id> authinfo;
  public QuorumPacket() {
  }
  public QuorumPacket(
        int type,
        long zxid,
        byte[] data,
        java.util.List<com.yahoo.zookeeper.data.Id> authinfo) {
    this.type=type;
    this.zxid=zxid;
    this.data=data;
  ...
  public java.util.List<com.yahoo.zookeeper.data.Id> getAuthinfo() {
    return authinfo;
  }
  public void setAuthinfo(java.util.List<com.yahoo.zookeeper.data.Id> m_) {
    authinfo=m_;
  }
    ...
    a_.writeBuffer(data,"data");
    {
      ...
      if (authinfo!= null) {          int len1 = authinfo.size();
          for(int vidx1 = 0; vidx1<len1; vidx1++) {
            com.yahoo.zookeeper.data.Id e1 = (com.yahoo.zookeeper.data.Id) authinfo.get(vidx1);
  ...
  public void deserialize(InputArchive a_, String tag) throws java.io.IOException {
    ...
    data=a_.readBuffer("data");
    {
      ...
      if (vidx1!= null) {          authinfo=new java.util.ArrayList<com.yahoo.zookeeper.data.Id>();
          for (; !vidx1.done(); vidx1.incr()) {
    com.yahoo.zookeeper.data.Id e1;
    e1= new com.yahoo.zookeeper.data.Id();
    a_.readRecord(e1,"e1");
            authinfo.add(e1);
          }
      }
  ...
  public boolean equals(Object peer_) {
    ...
    ret = (zxid==peer.zxid);
    if (!ret) return ret;
    ret = com.yahoo.jute.Utils.bufEquals(data,peer.data);
    if (!ret) return ret;
