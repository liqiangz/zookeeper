...
package com.yahoo.zookeeper.data;

import com.yahoo.jute.*;

public class ACL implements Record {
  private int perms;
  private com.yahoo.zookeeper.data.Id id;
  public ACL() {
  }
  public ACL(
        int perms,
        com.yahoo.zookeeper.data.Id id) {
    this.perms=perms;
    this.id=id;
  }
  public int getPerms() {
  ...
  public com.yahoo.zookeeper.data.Id getId() {
    return id;
  }
  public void setId(com.yahoo.zookeeper.data.Id m_) {
    id=m_;
  }
  ...
  public void deserialize(InputArchive a_, String tag) throws java.io.IOException {
    ...
    id= new com.yahoo.zookeeper.data.Id();
    a_.readRecord(id,"id");
    a_.endRecord(tag);
}
